...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'W1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Wheeler'), '2022-01-01');
